                        ...
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    ...
                                    {{ round((\App\Models\invoices::where('value_status', 2)->count() / \App\Models\invoices::count()) * 100, 3) }}
                                </span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="text-white op-7">
                                    {{ round((\App\Models\invoices::where('value_status', 1)->count() / \App\Models\invoices::count()) * 100, 3) }}
                                </span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            ...
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
                                <span class="text-white op-7">
                                    {{ round((\App\Models\invoices::where('value_status', 3)->count() / \App\Models\invoices::count()) * 100, 3) }}
                                </span>
                            </span>
                        </div>
                    </div>
